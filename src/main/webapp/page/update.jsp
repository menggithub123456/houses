...
<TABLE class=field>
  ...
  <TR>
    ...
    <TD><INPUT class=text type=date name=pubdate value="<fmt:formatDate
    value="${house.pubdate}" pattern="yyyy-MM-dd"></fmt:formatDate>"></TD></TR>
  <TR>
    <TD class=field>位　　置：</TD>
    <TD>区：
    <SELECT class=text name="did" id="district_id">
    </SELECT>
  ...
  <TR>
    ...
    <TD><INPUT id="ssss" class=text type="file" name="pfile"> 
      <img src="http://localhost:80/${house.path}" width="40px" height="40px">
